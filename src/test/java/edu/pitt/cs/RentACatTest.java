...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		Cat actual = r.getCat(2);
		assertEquals("Calling getCat() on an empty RentACat should return null", null, actual);
	}
	...
	public void testGetCatNumCats3() {
		...
		int actual = r.getCat(2).getId();
		assertEquals("Calling getCat() on valid id should return cat with specified id", 2, actual);
	}
	...
	public void testCatAvailableFalseNumCats0() {
		// TODO
		boolean actual = r.catAvailable(2);
		assertEquals("Calling catAvailable() on an empty RentACat should return false", false, actual);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean actual = r.catAvailable(2);
		assertEquals("Calling catAvailable() on an available cat should return true", true, actual);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean actual = r.catAvailable(2);
		assertEquals("Calling catAvailable() on a rented cat should return false", false, actual);
	}
	...
	public void testCatExistsFalseNumCats0() {
		// TODO
		boolean actual = r.catExists(2);
		assertEquals("Calling catExists() on an empty RentACat should return false", false, actual);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		boolean actual = r.catExists(2);
		assertEquals("Calling catExists() on an valid cat ID should return true", true, actual);
	}
	...
	public void testListCatsNumCats0() {
		...
		assertEquals("Calling listCats() on an empty RentACat should return an empty string", "", actual);
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("Calling listCats() on a RentACat with cats should list cats", expected, actual);
	}
	...
	public void testRentCatFailureNumCats0() {
		// TODO
		boolean actual = r.rentCat(2);
		assertEquals("Calling rentCat() on an empty RentACat should return false", false, actual);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean actual = r.rentCat(2);
		assertEquals("Calling rentCat() on a rented cat should return false", false, actual);
	}
	...
	public void testReturnCatFailureNumCats0() {
		// TODO
		boolean actual = r.returnCat(2);
		assertEquals("Calling returnCat() on an empty RentACat should return false", false, actual);
	}
	...
	public void testReturnCatNumCats3() {
		...
		boolean actual = r.returnCat(2);
		assertEquals("Calling returnCat() on a rented cat should return true", true, actual);
